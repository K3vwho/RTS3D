...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--mono_path', default='',
                             help='path to monopath')

    self.parser.add_argument('--interation', type=int, default=2,
                             help='interation.')
    ...
    self.parser.add_argument('--resl', type=int, default=10,
                             help='disable progress bar and print to screen.')
    self.parser.add_argument('--R_l', type=int, default=10,
                             help='disable progress bar and print to screen.')
    self.parser.add_argument('--R_h', type=int, default=10,
                             help='disable progress bar and print to screen.')
    self.parser.add_argument('--R_w', type=int, default=10,
                             help='disable progress bar and print to screen.')
    self.parser.add_argument('--pynum', type=int, default=4,
                             help='disable progress bar and print to screen.')
    self.parser.add_argument('--max_objs', type=int, default=17,
                             help='max objects num in an image')
  ...
  def parse(self, args=''):
    ...
    data_dir = opt.data_dir#'/freespace/kitti_formet/'
  ...
  def update_dataset_info_and_set_heads(self, opt, dataset):
    ...
    opt.heads = {'hm': opt.num_classes, 'hps_l': 18, 'hps_r': 18,'rot': 8}
